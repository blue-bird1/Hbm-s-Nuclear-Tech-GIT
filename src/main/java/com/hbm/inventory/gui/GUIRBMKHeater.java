...
public class GUIRBMKHeater extends GuiInfoContainer {
	...
	public void drawScreen(int mouseX, int mouseY, float f) {
		...
		FFUtils.renderTankInfo(this, mouseX, mouseY, guiLeft + 68, guiTop + 24, 16, 58,rod.feed);
		FFUtils.renderTankInfo(this, mouseX, mouseY, guiLeft + 126, guiTop + 24, 16, 58,rod.steam);
	}
	...
	protected void drawGuiContainerBackgroundLayer(float p_146976_1_, int p_146976_2_, int p_146976_3_) {
		...
		FFUtils.drawLiquid(rod.feed, guiLeft + 68, guiTop + 82, this.zLevel, 14, 58, 75,80);
		FFUtils.drawLiquid(rod.steam,guiLeft + 126, guiTop + 82, this.zLevel, 14, 58, 135, 80);
