...
public class RenderExplosiveCharge extends TileEntitySpecialRenderer<TileEntityCharge> {


	@Override
	public void render(TileEntityCharge tile, double x, double y, double z, float partialTicks, int destroyStage, float alpha) {
		GL11.glPushMatrix();
